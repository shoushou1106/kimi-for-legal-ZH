...
插件连接权威数据源时效果最佳。如果你构建或运营中国法律数据源、检索工具、合同管理系统（CLM）、电子签约平台、电子取证平台或律所管理系统，欢迎将你的 插件加入本套件。

## 优秀法律 插件的标准

- **基于 HTTPS 的远程 KIMI 插件**，支持 OAuth 或 API-key 认证（streamable HTTP 或 SSE 传输）
...
1. 发布你的 KIMI 插件，并文档化其工具、认证流程和数据覆盖范围。
