...
1. **加载审查指引。** 如果存在占位符，停止并提示运行 `「cold-start-interview」工作流（加载 commercial-legal/skills/cold-start-interview/SKILL.md）`。同时读取 `## 审查偏好` → `confirm_routing`。
...
```
「review」工作流（加载 commercial-legal/skills/review/SKILL.md） vendor-msa.pdf
「review」工作流（加载 commercial-legal/skills/review/SKILL.md） https://drive.google.com/file/d/ABC123
「review」工作流（加载 commercial-legal/skills/review/SKILL.md）
[粘贴协议文本]
```
