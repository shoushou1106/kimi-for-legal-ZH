...
1. 读取 `legal-profile/ip-legal.md`。如包含 `[占位符]`，停止并引导至 `「cold-start-interview」工作流（加载 ip-legal/skills/cold-start-interview/SKILL.md）`。
2. 遵循以下工作流。
...
```
「fto-triage」工作流（加载 ip-legal/skills/fto-triage/SKILL.md） "面向消费级可穿戴设备的端侧语音识别模型，中国市场首发"
```
