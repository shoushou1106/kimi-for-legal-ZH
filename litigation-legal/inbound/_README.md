...
|---|---|---|
| Demand letter received | `「demand-received」工作流（加载 litigation-legal/skills/demand-received/SKILL.md） [path]` | triage.md + optional response draft |
| Subpoena served | `「subpoena-triage」工作流（加载 litigation-legal/skills/subpoena-triage/SKILL.md） [path]` | triage.md + objections memo |
