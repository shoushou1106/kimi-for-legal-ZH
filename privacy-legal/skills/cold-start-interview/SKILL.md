...
如果旧的缓存路径 `legal-profile/（旧版缓存路径，已废弃） 中存在 CLAUDE.md 但不在配置路径，复制过来。
...
> **`privacy-legal` 是为运行个人信息保护计划的人准备的：个人信息保护影响评估、数据处理协议审查、个人信息主体权利请求回复、法规差距分析。** 不是你的领域？ `（该功能属于 Claude 技能市场生态，KIMI 版本已移除）`。
>
